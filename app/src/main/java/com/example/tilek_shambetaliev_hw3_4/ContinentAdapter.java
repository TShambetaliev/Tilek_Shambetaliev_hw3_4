...
import com.example.tilek_shambetaliev_hw3_4.databinding.ItemContinentsBinding;
...
public class ContinentAdapter extends RecyclerView.Adapter<ContinentViewHolder> {
    ...
    public ContinentAdapter(ArrayList<String> continentList, OnClick onItemClick) {
